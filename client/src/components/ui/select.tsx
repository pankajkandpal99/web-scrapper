  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        // Custom styles using your color scheme
        "border-[var(--input)] text-[var(--foreground)]",
        "[&_svg:not([class*='text-'])]:text-[var(--muted-foreground)]",
        "focus-visible:border-[var(--primary)] focus-visible:ring-[3px] focus-visible:ring-[var(--primary)]/20",
        "aria-invalid:ring-[var(--destructive)]/20 aria-invalid:border-[var(--destructive)]",
        "dark:bg-[var(--input)]/30 dark:hover:bg-[var(--input)]/50",
...
function SelectLabel({
  ...
  return (
    <SelectPrimitive.Label
      ...
      className={cn(
        "px-2 py-1.5 text-xs text-[var(--muted-foreground)]",
        className
      )}
      {...props}
    />
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        // Custom styles using your color scheme
        "[&_svg:not([class*='text-'])]:text-[var(--muted-foreground)]",
        "focus:bg-[var(--primary)]/10 focus:text-[var(--foreground)]",
        "data-[highlighted]:bg-[var(--primary)]/10 data-[highlighted]:text-[var(--foreground)]",
        className
      )}
      {...props}
    >
